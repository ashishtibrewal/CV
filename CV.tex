...
\BulletItem
Group Projects: Digital Design -- Peak Detector Design, Communications -- Wireless Modem Design, Professional Studies -- General Electric Audit Report, Interactive Devices -- Using Acoustic Sensing to Create a Touch Sensitive Surface, Robotic Systems -- Localistaion System Design
%\BulletItem
...
\begin{detailwithoutsubheading}
\BulletItem
\href{https://www.renishaw.com/}{Renishaw} is a world leading engineering company with expertise in high-precision measurement and health care, and is listed on the FTSE 250 index -- I was part of the Group Engineering division
\BulletItem
...
\begin{detailwithoutsubheading}
\BulletItem
\href{http://www.hiddenbrains.com/}{Hidden Brains} is a privately owned IT \& software development company with expertise in web, mobile application development, and embedded solutions -- I was part of the planning and analysis team for several website and mobile application development projects
\BulletItem
Analysed client proposal documents, drafted software requirement specification (SRS), scope of work, business requirement, and database documents, and created UML models
\BulletItem
Improved exsisting documents to minimise development required reducing delivery time and costs
...
\item
Received an honourable mention for the \textit{`Dean's International Intern Scholarship Scheme'} at \hfill {\DatestampYMD{2014}{11}{10}} \newline
the University of Bristol for my internship at \href{http://www.hiddenbrains.com/} {Hidden Brains InfoTech}
%\par\endgroup\par
\item
Recipient of the \textit{`Barry Thomas Scholarship for Computer Science'} at the University of Bristol \hfill {\DatestampYMD{2012}{10}{10}} 
\item
Delegate to the \textit{International Exchange Programme} held at \href{http://www.stives-h.schools.nsw.edu.au/}{St.Ives High School} in Sydney \hfill {\DatestampYMD{2010}{09}{10}}
\item
Recipient of \textit{`Major Colours'} for Lawn Tennis and Photography at The Assam Valley School \hfill {\DatestampYMD{2009}{05}{11}} -- {\DatestampYMD{2011}{07}{11}}
\item
Represented \textit{Assam} at the \textit{Junior National Squash Championships}, \href{https://www.mayocollege.com/}{Mayo College}, India \hfill {\DatestampYMD{2007}{08}{10}}
\end{itemslist}
\vspace{-5pt}
\hline
...
C, C++, \Csharp, Java, MATLAB, Haskell, SQL, VHDL, Verilog
\vspace{15pt}
\subsection
{Scripting/Markup:}
{Scripting/Markup}
...
{Tools}
{PDFsubsec:Tools}
Git, Vim, Bash, Gprof, VTune, Make, GDB, GCC, Valgrind, Bash, Visual Studio, MS Office Suite
\vspace{15pt}
\subsection
{Platforms:}
{Platforms}
