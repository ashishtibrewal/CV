...
\usepackage[
left=0.50in,	% was 0.70in
right=0.50in,	% was 0.70in
top=0.35in,		% was 0.70in
bottom=0.00in,
nohead,
includefoot]{geometry} % Use the showframe option to show page borders/margins
...
\newcommand{\DatestampMnew}[1]{\fontsize{9}{10.3}\selectfont\mbox{\ShortMonth{#1}}\normalsize}
...
{\par\begin{center}%
\par\begin{small}\onehalfspacing}% Was \begin{footnotesize}
{\par\end{small}% Was \end{footnotesize}
\par\end{center}\par}

% Macro: body (rest of the document).
\newenvironment{body}
{\par\vspace{-2.1em}\par		% was -1em
\begin{longtable}[c]{@{\hspace*{-0pt}}p{0.13\textwidth}p{0.825\textwidth}}}	% Also works without the asterisk
...
{\vspace*{-2.1em}\par\begingroup\fontsize{10}{10.3}\selectfont\begin{itemize}[leftmargin=0pt, itemindent=0pt, label={}]\setlength{\itemsep}{3pt}\setlength{\parskip}{0cm}}
